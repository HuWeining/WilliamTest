app.controller('promotionDetailCtrl', [ '$scope', 'recommendationService','$stomp', '$uibModal','$state'
    ...
    init = function() {
        for (var i = 0; i < $scope.chosenPlan.promotionItemLists.length; i++){
            var oneSiteAndItems = $scope.chosenPlan.promotionItemLists[i];
